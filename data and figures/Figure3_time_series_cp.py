...
for i, model in enumerate(models):
    ...
    Global_ATCw_slope, _, _, Global_ATCw_pValue, _ = linregress(years, Global_ATCw)
    Global_ATCc_slope, _, _, Global_ATCc_pValue, _ = linregress(years, Global_ATCc)
    Northern_ATCw_slope, _, _, Northern_ATCw_pValue, _ = linregress(years, NH_ATCw)
    Northern_ATCc_slope, _, _, Northern_ATCc_pValue, _ = linregress(years, NH_ATCc)
    Southern_ATCw_slope, _, _, Southern_ATCw_pValue, _ = linregress(years, SH_ATCw)
    Southern_ATCc_slope, _, _, Southern_ATCc_pValue, _ = linregress(years, SH_ATCc)
...
plt.savefig(str(current_directory)+'/Figure3_time_series_cp.png',dpi=300)
#plt.show()
