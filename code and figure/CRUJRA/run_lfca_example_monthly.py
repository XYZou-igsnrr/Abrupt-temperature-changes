...
dataset = nc.Dataset("/data1/zxy/sudden_temp_change/CRU_JAR_tmp/EOF/monthly/T_change_freq_monthly_1901-2020.nc")
ATCw=dataset["T_change_up_freq"][828:,:] #1970-2020
ATCc=dataset["T_change_down_freq"][828:,:] #1970-2020
print(ATCw.shape)
sys.stdout.flush()
...
ATCw_eofs_aug = np.zeros((nrows,ATCw_eofs.shape[1]+nins))
ATCc_eofs_aug = np.zeros((nrows,ATCc_eofs.shape[1]+nins))
...
new = nc.Dataset(str(current_directory)+"/LFCA_result_monthly_1970_2020.nc", 'w')
