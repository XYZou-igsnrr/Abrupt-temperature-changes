...
dataset = nc.Dataset("/data1/zxy/sudden_temp_change/ERA5_tmp/LFCA/ATC_monthly/T_change_freq_monthly_ERA5_1970_2020_0.5d.nc")
...
new = nc.Dataset(str(current_directory)+"/LFCA_result_"+str(model)+"_1970_2020_monthly.nc", 'w')
