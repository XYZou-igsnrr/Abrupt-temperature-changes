...
if __name__ == "__main__":
    ...
    station_csv=pd.read_csv("/data1/zxy/sudden_temp_change/ISD-global-daily/station_unique_1970.csv")
    ...
    #csv
    csv_file = open(str(current_directory)+'/station_sudden_change_+10°C_after_1973.csv', 'w', newline='', encoding='utf-8')
