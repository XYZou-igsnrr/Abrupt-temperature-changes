...
for i, model in enumerate(models):
    ...
    if model=='CRUJRA':
        ...
        dataset = nc.Dataset("/data1/zxy/sudden_temp_change/CMIP6_daily_tas/"+str(model)+"/T_change_freq_"+str(model)+"_yearly_1970-2015.nc")
    ...
    print('ATCw_slope_SH',ATCw_slope_SH)
    print('ATCc_slope_SH',ATCc_slope_SH)
