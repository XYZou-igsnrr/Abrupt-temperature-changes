...
CRUJRA_dataset = nc.Dataset("/data1/zxy/sudden_temp_change/CRU_JAR_tmp/CRUJRA_sudden_T_change_freq_trend_±10°C_1970_2020.nc")
...
ERA5_dataset = nc.Dataset("/data1/zxy/sudden_temp_change/ERA5_tmp/ERA5_ATC_trend_1970_2020.nc")
...
for i, model in enumerate(models):
    ...
    ATC_slope_CMIP6.append(dataset['ATC_trend_slpoe'][:]*365)
...
#ATC_ave_CMIP6[dataset['T_change_up_freq_trend_slpoe'][:].mask]=np.nan
#ATC_sig_mask[dataset['T_change_up_freq_trend_slpoe'][:].mask]=False
...
for i, model in enumerate(models):
    ...
    if model=='CRUJRA':
        ...
        dataset = nc.Dataset("/data1/zxy/sudden_temp_change/ERA5_tmp/ERA5_ATC_trend_1970_2020.nc")
...
#plt.tight_layout()
fig1 = plt.gcf()
fig1.savefig(str(current_directory)+"/Figure2_map_ATC_trend_occurrence_cp.png", dpi=300)
#plt.show()
